...
month_exp_chart = px.bar(cleaned_month, x = 'Name', y = 'Monthly_Exp_Count',color = 'Name', color_discrete_sequence= ['SeaGreen','MediumPurple','Tomato'])
